...
class class_user_profile_functions{
	...
	function user_profile_filter_profile_navs_following($user_id){
        ...
        foreach($follower_query as $entry){
			...
			$user_profile_cover = get_the_author_meta( 'user_profile_cover', $user_id );		
			...
			?><div class="single">
            	<div class="cover"><a href="<?php echo $user_profile_page_url.'?id='.$author_id; ?>"><img src="<?php echo $user_profile_cover; ?>" /></a></div>            
	...
	function user_profile_filter_profile_navs_follower($user_id){
        ...
        foreach($follower_query as $entry){
			...
			?><div class="single">
            	<div class="cover"><a href="<?php echo $user_profile_page_url.'?id='.$follower_id; ?>"><img src="<?php echo $user_profile_cover; ?>" /></a></div>            
